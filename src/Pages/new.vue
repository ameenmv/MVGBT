  ...
  <div class="p-8 py-4 h-[100vh] rounded-[40px] border-t border-b">
    <div class="flex">
      ...
      <div class="w-[20%] pr-8">
        ...
        <p v-for="(text, i) in texts" :key="i" class="mt-3">
          {{ text.slice(0, 30) + (text.length > 30 ? "..." : "") }}
        </p>
      </div>

      <!-- right -->
      <div class="w-[80%] border-l h-[98vh] p-3 pt-9 flex flex-col">
        <!-- header -->
        ...
        <!-- input -->
        <div class="flex justify-center w-[65%] mx-auto">
          <div
          ...
          >
            ...
            <div class="flex mt-3 justify-between items-center">
              ...
              <div class="flex gap-2">
                ...
                <div
                  class="btn flex gap-1 border border-[var(--border)] !px-[10px] !py-[5px]"
                  @click="sendMessage"
                >
                  <svg
                    width="20px"
        ...
        <!-- footer -->
        <div class="mt-6 flex text-[15px] justify-center">
          <div class="opacity-[.6]">
  ...
  data() {
    return {
      ...
      texts: [
        ...
        `It has been trained on a diverse dataset...`,
      ],
    };
  },
  methods: {
